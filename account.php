...
$reservation_date_drop =$datedrop;
  ...
  $stmt->bind_param('sssiissssi',$reservation_date,$reservation_date_drop,$date_reservation_final,$carId,$user_id,$eservation_status,$reservation_time,$durtion,$description,$amount);
