...
require 'phpmailer/src/SMTP.php';
    ...
    $mail->Body = '<p>Cher utilisateur <span style="color:coral;">ExpressDXB</span> <br> Merci pour la creation de votre compte ' . $name . ',</p><br>
    <p>Si vous ne l\'avez pas effectuer cette action, ignorez et supprimer cet email. </p><br>
    <p> Equipe <span style="font-weight:blod;">Gabeyes</span></p>';
...
//account not be created
  ...
  header('location: register.php?error=could not create an account at the momemt');
