...
if(isset($_GET['page_no'])  && $_GET['page_no'] != ""){
  ...
  // return number of products 
   $stmt1 = $conn->prepare("SELECT COUNT(*) AS total_records FROM comment");
  ...
  //4. gets all products
  $stmt2 = $conn->prepare("SELECT * from comment limit $offset,$total_records_per_page");
  $stmt2->execute();
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-striped table-sm table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td><img src="../assets/imgs/user.png" style="with:70px; height:70px"></td>
                            <td><?php echo $users['comment_id'] ; ?></td>
                            <td><?php echo $users['comment_name'] ; ?></td>
                            <td><?php echo $users['comment_text'] ; ?></td>
                            <td><a class="btn btn-primary" href="activ_comment.php?product_id=<?php echo $users['comment_id'] ; ?>">></a></td>
                            <td><a class="btn btn-danger" href="disable_comment.php?product_id=<?php echo $users['comment_id'] ; ?>">x</a></td>
                            </tr>
                            <?php    } ?>
                        </tbody>
                    </table>
