...
$mail1->isHTML(true);
    ...
    <div class="row">
    <div class="col"><a href="http://13.60.47.219/mode.php?id=1&mode='.$reservation_id.'">Airtel Money</a></div>
    <div class="col"><a href="http://13.60.47.219/mode.php?id=2&mode='.$reservation_id.'">Moov Money</a></div>
    <div class="col"><a href="http://13.60.47.219/mode.php?id=3&mode='.$reservation_id.'">Carte de crédit</a></div>
    <div class="col"><a href="http://13.60.47.219/mode.php?id=4&mode='.$reservation_id.'">Cash</a></div>
    </div><br
    <p>Veuillez vous connecter pour plus information <a href="http://13.60.47.219>admin</a>. </p><br>
