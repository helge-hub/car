                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Fiche création voiture</h6>
                        </div>
                        <div class="card-body">
                            <form id="create-form" enctype="multipart/form-data" action="create_product.php"  method="post">
                                ...
                                <label>Nom du véhicule</label>
                                    <input type="text" class="form-control" id="car_name"  name="name" placeholder="Entrer le nom de la voiture..." required>
                                </div>
                            
                                <div class="form-group mt-2">
                                    <label>Description</label>
                                    <input type="text" class="form-control" id="car_model"  name="description" placeholder="Description" required>
                                </div>
                                <div class="form-group mt-2">
                                    <label>Prix journalier</label>
                                    <input type="number" class="form-control" id="car_price"  name="price" placeholder="Enter un prix..." required>
                                </div>
                                <div class="form-group mt-2">
                                    <label>Kilométrage</label>
                                    <input type="text" class="form-control" id="km"  name="km" placeholder="Enter le kilométrage" required>
                                </div>
                                <div class="form-group mt-2">
                                    <label>Nombre de place</label>
                                    <input type="number" class="form-control" id="sit"  name="car_sit" placeholder="Enter le nombre de place" required>
                                </div>
                                <div class="form-group mt-2">
                                    <label>Année</label>
                                    <input type="text" class="form-control" id="an"  name="an" placeholder="Enter l'année" required>
                                </div>
                                <div><hr></div>
                                <div class="form-group mt-2">
                                    <label>Navigation GPS</label>
                                    <select class="form-select form-select-lg mb-3" aria-label="Large select example" name="gps">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <select class="form-select form-select-lg mb-3" aria-label="Large select example" name="car_autoradio">
